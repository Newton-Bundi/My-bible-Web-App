// Really proud of this code!!! it dispalys and retains the inputs on the beer description and reviews


// Populating the webpage with information on the 1st beer and including the rest in the nav bar
